...
class PhpPipelinesProvider implements UserAgentProviderInterface
{
    final public const PRODUCT_NAME = 'klevu-php-pipelines';
    ...
    {
        try {
            $version = InstalledVersions::getVersion('klevu/php-pipelines');
